...
/* Begin Security class. This is creating my own personal class called Starbase13HangarBayLanding, allowing custom steps be made
        ...
        while (!passwordInput.equals("privacy")) {
            ...
            switch (roomOption)
            {
                case 1:
                    ...
                    System.out.println("The touchscreen shows a full keyboard and asks for a password. It also notes" +
                    ...
                    else
                    {
                        ...
                        System.out.println("The advisor you ask mistakes you for a crew member and lets you know the " +
                                "password is 'privacy'.\nYou should head back to the door and try again.");
